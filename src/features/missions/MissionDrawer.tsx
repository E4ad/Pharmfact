...
import { calculateBalanceDue, createInvoicePayment } from '../../services/invoiceWorkflow';
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h6" sx={{ flex: 1, fontWeight: 800, fontSize: '1rem', minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {pharmacy ? pharmacieDisplayName(pharmacy) : 'Mission'}
          </Typography>
        ...
        {/* Scrollable body */}
        <Box sx={{ flex: 1, overflowY: 'auto', overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch' }}>
          {/* Dark résumé panel */}
          <Box sx={{ p: 2.5, pb: 0 }}>
            <MissionSummaryPanel
